...
void LwIP_Init(void)
{
  ...
  gw.addr = 0;
#else
  IP4_ADDR(&ipaddr,eth_ini_dat.IP_ADR[0],eth_ini_dat.IP_ADR[1],eth_ini_dat.IP_ADR[2],eth_ini_dat.IP_ADR[3]);
  IP4_ADDR(&netmask,eth_ini_dat.MASK[0],eth_ini_dat.MASK[1],eth_ini_dat.MASK[2],eth_ini_dat.MASK[3]);
  IP4_ADDR(&gw,eth_ini_dat.GW_ADR[0],eth_ini_dat.GW_ADR[1],eth_ini_dat.GW_ADR[2],eth_ini_dat.GW_ADR[3]);

#ifdef USE_LCD  
   iptab[0] = eth_ini_dat.TCP_ADR[3]; //IP_ADDR3;
   iptab[1] = eth_ini_dat.TCP_ADR[2]; //IP_ADDR2;
   iptab[2] = eth_ini_dat.TCP_ADR[1]; //IP_ADDR1;
   iptab[3] = eth_ini_dat.TCP_ADR[0]; //IP_ADDR0;
